...
const UserInfo = ({ setPopup }: { setPopup: any }) => {
  return (
    <>
      ...
      <div className="flex justify-center w-full items-start gap-4 p-5 mt-14 flex-col">
        <div className="flex justify-center items-start w-full flex-col">
          <p className="text-2xl font-bold">My Name</p>
          <p className="text-gray-500 text-xs">@myusername</p>
        </div>
        <p className="font-medium">Hello my name is My Name</p>
        <p className="font-medium">
          <SlCalender className="inline-block mr-1" /> Joined April 2024
        </p>
